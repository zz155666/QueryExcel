...
namespace MetroFramework
{
    public partial class MetroMessageBoxControl : Form
    {
        ...
        private Color _defaultColor =Color.FromArgb(255, 128, 0);//
        ...
        public void ArrangeApperance()
        {
            ...
            switch (_properties.Buttons)
            {
                ...
                case MessageBoxButtons.OKCancel:
                    ...
                    metroButton1.Tag = DialogResult.Cancel;
                    EnableButton(metroButton2);

                     metroButton2.Text = "&确定";
                    metroButton2.Location = metroButton3.Location;
                    metroButton2.Tag = DialogResult.OK;
        ...
        private void MetroMessageBoxControl_KeyDown(object sender, KeyEventArgs e)
        {
